...
Bot_Name = (Redis:get(Zelzal.."Zelzal:Name:Bot") or "جاك")
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Smile"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Smile"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Smile"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
local convert_mony = string.format("%.0f", new_balance)
return send(msg_chat_id,msg_id,"⇽اجابة صحيحة !\n⇽عدد الثواني ↤︎ "..seconds_taken.."\n⇽فلوسك ↤︎ ( "..convert_mony.." ريال 💸 )","md",true)
else
return send(msg_chat_id,msg_id,"⇽اجابة صحيحة !\n⇽عدد الثواني ↤︎ "..seconds_taken.."\n♡","md",true)
end
end
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Monotonous"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Monotonous"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Monotonous"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:alam"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Game:StartTime:alam"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:ausm"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Game:StartTime:ausm"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Riddles"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Riddles"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Riddles"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Meaningof"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Meaningof"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Meaningof"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Reflection"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Reflection"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Reflection"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 500
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
local convert_mony = string.format("%.0f", new_balance)
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ تم اضافة لك ( 500 ريال 💸 )\n⇜ فلوسك ↤︎ ( "..convert_mony.." ريال 💸 )","md",true)  
else
return send(msg_chat_id,msg_id,"⇜ مبروك فزت وخمنت الرقم الصحيح\n⇜ ماعندك حساب بنكي ارسل ↤︎ ( `انشاء حساب بنكي` )","md",true)  
end
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Difference"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Difference"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Difference"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:Example"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:Example"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:Example"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal..'Game:StartTime:SetAnswer'..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Games:Set:Answer"..msg.chat_id)
Redis:del(Zelzal..'Game:StartTime:SetAnswer'..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 500
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
local start_time = Redis:get(Zelzal.."Game:StartTime:klmaa"..msg.chat_id)
local end_time = os.time()
local seconds_taken = start_time and string.format("%.2f", end_time - start_time) or "0.00"
Redis:del(Zelzal.."Zelzal:Game:klmaa"..msg.chat_id)
Redis:del(Zelzal.."Game:StartTime:klmaa"..msg.chat_id)
if Redis:sismember(Zelzal.."booob",msg.sender_id.user_id) then
local current_balance = Redis:get(Zelzal.."boob"..msg.sender_id.user_id) or 0
local new_balance = tonumber(current_balance) + 100
Redis:set(Zelzal.."boob"..msg.sender_id.user_id, new_balance)
...
if msg.sender_id.user_id == 7728230165 or msg.sender_id.user_id == 7728230165 or msg.sender_id.user_id == 7728230165 then
return send(msg_chat_id,msg_id,'*- يـايمـه انتـه العشـق مالـي زلــزال الهيبـه 💞😻*',"md",true) 
elseif msg.sender_id.user_id == 7728230165 then
...
hazrwinerid = Redis:get(Zelzal.."hazrwinerid"..msg.chat_id) or 7728230165
